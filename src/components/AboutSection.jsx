        ...
        <div className="flex items-start gap-2">
          <div className="relative">
            ...
            <button
              ...
              className="absolute left-1/2 top-1/3 -translate-x-1/2 -translate-y-1/2 h-16 w-16 rounded-full bg-white shadow flex items-center justify-center"
            >
              <svg
              ...
              >
                <path d="M8.25 4.5v15l10.5-7.5-10.5-7.5z" />
              </svg>
            </button>
