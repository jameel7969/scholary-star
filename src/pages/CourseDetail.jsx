...
import course03 from "../assets/course-03.jpg";
import course04 from "../assets/course-04.jpg";
import course05 from "../assets/course-05.jpg";
      ...
      <section className="relative overflow-hidden bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 md:py-24">
          ...
          <p className="mt-2 text-slate-600 max-w-2xl">
            Learn with hands-on projects and mentor feedback.
          </p>
        </div>
        <img
          src={shapeArrow}
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 grid gap-10 lg:grid-cols-3">
        <div className="lg:col-span-2">
          ...
          <ul className="mt-6 flex flex-wrap gap-3 text-xs text-slate-600">
            <li className="rounded-full bg-slate-100 px-3 py-1">
              Duration: 8 weeks
            </li>
          ...
          <div className="mt-8">
            ...
            <p className="text-slate-700">
              This course covers end-to-end skills with real-world examples and
              bite-sized lessons that fit your schedule. Get feedback from
              mentors and join peer discussions.
            </p>
          </div>
          <div className="mt-8">
            <h3 className="text-xl font-bold text-slate-900 mb-3">
              ...
              {curriculum.map((c, i) => (
                <li key={i} className="flex items-center justify-between p-4">
                  <span className="flex items-center gap-3">
                    <span className="grid h-7 w-7 place-items-center rounded-full bg-emerald-100 text-emerald-700 font-semibold">
                      {i + 1}
                    </span>
                    {c}
                  </span>
          ...
          <div className="mt-8">
            ...
            <div className="space-y-4">
              <div className="rounded-xl border border-slate-200 p-4">
                ...
                <p className="text-slate-700">
                  Practical and engaging. Highly recommended!
                </p>
              </div>
              <div className="rounded-xl border border-slate-200 p-4">
                <div className="font-semibold">Robert Fox</div>
                <p className="text-slate-700">
                  Great content and mentor support.
                </p>
              </div>
            </div>
          </div>
        ...
        <aside>
          <div className="sticky top-24 rounded-2xl border border-slate-200 p-6 shadow-sm">
            ...
            <Link
              to="/checkout"
              className="mt-6 inline-flex w-full items-center justify-center rounded-full bg-emerald-600 px-6 py-3 font-semibold text-white hover:bg-emerald-500"
            >
              Enroll Now
            </Link>
